...
class pluginBlugerContact extends Plugin {
	...
	public function form()
	{
		...
		$html .= '<div>';
		$html .= '<label>'.$L->get('Bluger Contact').'</label>';
	...
	{
		$html  = '<div class=" col-md-12 p-3 plugin plugin-bluger-contact text-white text-center">';
